<x-guest-layout>
                                    ...
                                    <form action="{{ route('register') }}" method="post" class="mt-5">
                                        ...
                                        <div class="mt-4">
                                            <div class="flex items-center justify-center w-full">
                                                <label for="image"
                                                    class="flex flex-col items-center justify-center w-full h-[12rem] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 hover:bg-gray- dark:hover:border-gray-500 dark:hover:bg-gray-300 transition-all">
    ...
    <div class="block md:hidden bg-gray-200 py-20"
        style="background-image: url('{{ Vite::asset('/resources/images/image 4.png') }}'); background-size: cover; background-position: center;">
    ...
    <div class="bg-white">
        <div class="max-w-sm md:max-w-[100rem] py-28 mx-auto ">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <div class="flex flex-col font-bold gap-y-8">
                    <div class="text-2xl md:text-5xl w-fit md:w-[50rem] leading-12 ">
                        Streamlining the Procedure
                        to Register Your Workshop
                    </div>
                    <div class="w-fit md:w-[45rem] text-gray-500 text-md">
